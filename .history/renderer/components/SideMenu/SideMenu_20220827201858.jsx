            ...
            <ul>
                ...
                <li>
                    ...
                    href='/AddIncomePage/AddIncomePage'>
                        <div className={[viewincomeState && styles["sidebar_item_selected"], styles["sidebar_item"]].join(" ")}>Add Income</div>
                    </Link>
                </li>
                <li>
                    ...
                    <Link 
                    href='/ViewExpensePage/ViewExpensePage'>
                        <div className={[viewincomeState && styles["sidebar_item_selected"], styles["sidebar_item"]].join(" ")}>Add Expense</div>
                    </Link>
                </li>
            </ul>

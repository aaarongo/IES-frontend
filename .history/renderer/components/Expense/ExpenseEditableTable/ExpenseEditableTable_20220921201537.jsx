...
export default function ExpenseEditableTable({ reload, expenseEditableData, expenseCategories }) {
  ...
  const handleCloseEditModal = () => { setopenMoreModal(false) };
  ...
  const handleCloseMoreModal = () => { setOpenDeleteModal(false); };
  ...
  return (
    ...
    <Modal open={openMoreModal} onClose={handleCloseEditModal}>
      <div className={styles.modal}>
        <EditExpenseModal
    ...
    <Modal open={openDeleteModal} onClose={handleCloseMoreModal}>
      <div className={styles.modal}>
        <DeleteExpenseModal

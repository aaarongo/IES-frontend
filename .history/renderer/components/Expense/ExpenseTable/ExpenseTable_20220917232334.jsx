...
export default function ExpenseTable({ reload, expenseData }) {
  ...
  //columns
  const headCells = [
    { field: 'transactionId', headerName: 'ID', minWidth: '50px', align: 'left'},
    { field: 'transactionDate', headerName: 'Transaction Date', minWidth: 100, align: 'left'},
    { field: 'supplyName', headerName: 'Supply Name', minWidth: 100, align: 'left'},
    { field: 'expenseCost', headerName: 'Cost', minWidth: 100, align: 'left'}
  ];

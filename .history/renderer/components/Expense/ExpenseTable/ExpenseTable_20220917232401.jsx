...
export default function ExpenseTable({ reload, expenseData }) {
  ...
  //columns
  const headCells = [
    { field: 'transactionId', headerName: 'ID', minWidth: 20, align: 'left'},
    { field: 'transactionDate', headerName: 'Transaction Date', minWidth: 20, align: 'left'},
    { field: 'supplyName', headerName: 'Supply Name', minWidth: 20, align: 'left'},
    { field: 'expenseCost', headerName: 'Cost', minWidth: 20, align: 'left'}
  ];

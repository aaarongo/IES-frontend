...
export default function ExpenseTable({ reload, expenseData }) {
  ...
  //columns
  const headCells = [
    { field: 'transactionId', headerName: 'ID', minWidth: '20px', align: 'left'},
    { field: 'transactionDate', headerName: 'Transaction Date', minWidth: '20px', align: 'left'},
    { field: 'supplyName', headerName: 'Supply Name', minWidth: '20px', align: 'left'},
    { field: 'expenseCost', headerName: 'Cost', minWidth: '20px', align: 'left'}
  ];

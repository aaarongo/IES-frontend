...
export default function ExpenseTable({ expenseData }) {
  ...
  const requestSearch = (searchValue) => {
    const filteredRows = expenseData.filter((row) => {
      return String(row.supplyName).toLowerCase().includes(searchValue.toLowerCase()) || row.transactionDate.toLowerCase().includes(searchValue.toLowerCase()) || String(row.expenseCost).includes(searchValue);
      });

...
export default function IncomeTable() {
    const EnhancedTableToolbar = (props) => {
     ...
     //table headers
  const headCells = [
    { field: 'expenseId', headerName: 'ID', flex: 1, align: 'center' },
    { field: 'expenseCategory', headerName: 'Category', flex: 1, align: 'right' },
    { field: 'expenseDate', headerName: 'Date', flex: 1, align: 'right' },
    { field: 'expenseCost', headerName: 'Cost', flex: 1, align: 'right' },
  ]

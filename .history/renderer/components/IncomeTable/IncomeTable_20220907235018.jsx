...
export default function IncomeTable() {
  ...
  const requestSearch = (searchValue) => {
    const filteredRows = allRows.filter((row) => {
      return String(row.expenseId).includes(searchValue) || row.expenseCategory.toLowerCase().includes(searchValue.toLowerCase()) || row.String(expenseCost).includes(String(searchValue)) ;
    });

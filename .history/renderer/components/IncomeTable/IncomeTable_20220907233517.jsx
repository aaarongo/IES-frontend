...
//   const [rows, setRows] = useState([]);
  ...
  const rows = [
    { expenseId: 1, expenseCategory: 'Snow', expenseDate: 'Jon', expenseCost: 35 },
    { expenseId: 2, expenseCategory: 'Lannister', expenseDate: 'Cersei', expenseCost: 42 },
    { expenseId: 3, expenseCategory: 'Lannister', expenseDate: 'Jaime', expenseCost: 45 },
    { expenseId: 4, expenseCategory: 'Stark', expenseDate: 'Arya', expenseCost: 16 },
    { expenseId: 5, expenseCategory: 'Targaryen', expenseDate: 'Daenerys', expenseCost: null },
    { expenseId: 6, expenseCategory: 'Melisandre', expenseDate: null, expenseCost: 150 },
    { expenseId: 7, expenseCategory: 'Clifford', expenseDate: 'Ferrara', expenseCost: 44 },
    { expenseId: 8, expenseCategory: 'Frances', expenseDate: 'Rossini', expenseCost: 36 },
    { expenseId: 9, expenseCategory: 'Roxie', expenseDate: 'Harvey', expenseCost: 65 },
  ];

...
export default function IncomeTable() {
  ...
  const requestSearch = (searchValue) => {
    const filteredRows = allRows.filter((row) => {
      return String(row.expenseId).includes(searchValue) || row.expenseCategory.toLowerCase().includes(searchValue.toLowerCase()) || row.expenseDate.toLowerCase().includes(searchValue.toLowerCase()) || String(row.expenseCost).includes(searchValue);
    });

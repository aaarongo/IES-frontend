  ...
  return (
    <div className={styles.container}>
      <div className={styles.box}>
        ...
        <div className={styles.content}>
          {posts.posts && posts.posts.slice(0,30).map((item) => {
            return (
              <div>
                <div className={styles.row_content_header}>Date</div>
                <div className={styles.row_content_header}>Expense</div>
                <div className={styles.row_content_header}>Income</div>

...
function HomePage() {
  ...
  const [dData, setdData] = useState({
    ...
    datasets: [
      {
        label: "Income",
        data: UserData.donutData.map((data) => data.income),
        backgroundColor: ["#35b000",],
      },
      {
        label: "Expense",
        data: UserData.donutData.map((data) => data.expense),
        backgroundColor: ["#e10000",],
      },
      {
        label: "Savings",
        data: UserData.donutData.map((data) => data.savings),
        backgroundColor: ["#a8763e",],
      },
    ],
  });
      ...
      <div className={styles.section}>
        ...
        <div className={styles.content}>
          ...
          <div className={styles.charts}>
            <IncomeExpenseChart bData={bData , } />
          </div>
        </div>
      </div>
    </div>

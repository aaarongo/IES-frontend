  ...
  return (
    <div className={styles.container}>
        <div className={styles.header}>
          ...
          <div className={styles.print_btn_container}><LocalPrintshopIcon /></div>
        </div>
        <div className={styles.table}>
            <Table stickyHeader>
                ...
                {rows.map((row) => (
                    ...
                    <TableCell className={styles.delete_btn} align="center"><RemoveCircleRoundedIcon sx={{ color:"red" }} /></TableCell>
                    </TableRow>
                ))}
                </TableBody>
            </Table>
